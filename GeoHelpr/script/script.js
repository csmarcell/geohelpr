function navbar() {
    ...
    placeholder.innerHTML = `
        <nav class="navbar">
            ...
            <ul class="menu">
                <li class="item"><a href="basics.html">Alapok</a></li>
                <li class="item"><a href="bollards.html">Vezetőoszlopok</a></li>
                <li class="item"><a href="cars.html">Google autók</a></li>
                <li class="item"><a href="roadlines.html">Útfestések</a></li>
                <li class="item"><a href="poles.html">Villanyoszlopok</a></li>
